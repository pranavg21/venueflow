  ...
  app.use(helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        imgSrc: ["'self'", 'data:', 'https://*.googleapis.com', 'https://*.gstatic.com', 'https://*.google.com'],
        connectSrc: ["'self'", 'https://*.firebaseio.com', 'https://*.googleapis.com', 'wss://*.firebaseio.com', 'https://generativelanguage.googleapis.com'],
        frameSrc: ["'none'"],
        objectSrc: ["'none'"],
      },
    },
